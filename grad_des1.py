...
# 1. Load database
data = pd.read_csv("Lab1B data.csv")
...
learning_rates_m = [0.1, 0.01, 0.001, 0.00005099,0.000311,0.00001,0.00002,0.000003,0.00004,0.000051,0.000055,0.000059]
learning_rates_c = [0.1,0.2,0.13,0.15,0.18, 0.01,0.025,0.0293,0.029994,0.5,0.6, 0.001, 0.0001,0.00001,0.000001,0.0000001]
best_m = 0
best_c = 0
min_error = float('inf')
best_lr_m = 0
